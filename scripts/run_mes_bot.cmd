...
REM push the live status + closed-trade history to the VM dashboard (Futures tab reads them there)
...
if exist futures\trades.json scp -o BatchMode=yes -o ConnectTimeout=15 futures\trades.json trading-vm:/home/ubuntu/trading/futures/trades.json >> logs\mes_bot.log 2>&1
